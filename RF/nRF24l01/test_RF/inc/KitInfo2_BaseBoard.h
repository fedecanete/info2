...
//ADC
#define 	ADC5		PORT1,31	//ADC5	//es el pote (OJO! el plano indica ADC0)
#define 	ADC1		PORT0,24	//ADC1	//termistor
#define 	ADC2		PORT0,25	//ADC2	//entrada libre
#define 	DAC			PORT0,26	//DAC	//salida analógica
