...
#ifndef TECLADO_5X1_H_
#define TECLADO_5X1_H_
	...
	uint8_t TecladoHW (void);	//Driver
	void TecladoSW (uint8_t);	//Driver
	void DriverTeclado(void);	//Driver

#endif /* TECLADO_5X1_H_ */
